...
//validador de datos para no obtener campos vacios 
    if ((d != 0) && (p != 0) && (a != 0)){
...
// formatear dos decimales 
            imc = imc.toFixed(2) 
            const result = imc >= 30 ? alert ("Su peso sera: " + resultado + " y su indice de masa corporal es " + imc + " su composicion corporal es Obesidad, debe seguir la dieta") : (imc < 30) && (imc >= 25 ) ? alert ("Su peso sera: " + resultado + " y su indice de masa corporal es " + imc + " su composicion corporal es superior al normal, debe seguir la dieta") :  (imc < 25) && (imc >= 18.5) ? alert ("Su peso sera: " + resultado + " y su indice de masa corporal es " + imc + " su composicion corporal es normal, debe pausar la dieta") : imc < 18.5 ? alert ("Su peso sera: " + resultado + " y su indice de masa corporal es " + imc + " su composicion corporal es inferior al normal, debe aumentar su masa corporal") : false

        }
      }
      else {alert ("error, no ingreso correctamente los datos")}